...
let S = class extends HTMLElement {
  ...
  static getPropertyDescriptor(e, t, i) {
    const { get: s, set: r } = Te(this.prototype, e) ?? { get() {
      return this[t];
    }, set(a) {
      this[t] = a;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(C("properties"))) {
      const t = this.properties, i = [...Re(t), ...Me(t)];
  ...
  _$AK(e, t) {
    ...
    if (s !== void 0 && this._$Em !== s) {
      const n = i.getPropertyOptions(s), c = typeof n.converter == "function" ? { fromAttribute: n.converter } : ((r = n.converter) == null ? void 0 : r.fromAttribute) !== void 0 ? n.converter : J;
      this._$Em = s;
  ...
  requestUpdate(e, t, i, s = !1, r) {
    ...
    if (e !== void 0) {
      ...
      if (s === !1 && (r = this[e]), i ?? (i = n.getPropertyOptions(e)), !((i.hasChanged ?? we)(r, t) || i.useDefault && i.reflect && r === ((a = this._$Ej) == null ? void 0 : a.get(e)) && !this.hasAttribute(n._$Eu(e, i)))) return;
      this.C(e, t, i);
    }
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const N = globalThis, le = (o) => o, Q = N.trustedTypes, ue = Q ? Q.createPolicy("lit-html", { createHTML: (o) => o }) : void 0, _e = "$lit$", _ = `lit$${Math.random().toFixed(9).slice(2)}$`, $e = "?" + _, ze = `<${$e}>`, E = document, z = () => E.createComment(""), L = (o) => o === null || typeof o != "object" && typeof o != "function", ie = Array.isArray, Le = (o) => ie(o) || typeof (o == null ? void 0 : o[Symbol.iterator]) == "function", D = `[ 	
\f\r]`, R = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, de = /-->/g, he = />/g, k = RegExp(`>|${D}(?:([^\\s"'>=/]+)(${D}*=${D}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), pe = /'/g, me = /"/g, ke = /^(?:script|style|textarea|title)$/i, je = (o) => (e, ...t) => ({ _$litType$: o, strings: e, values: t }), u = je(1), I = Symbol.for("lit-noChange"), p = Symbol.for("lit-nothing"), ge = /* @__PURE__ */ new WeakMap(), P = E.createTreeWalker(E, 129);
function Pe(o, e) {
...
const Ue = (o, e) => {
  ...
  for (let n = 0; n < t; n++) {
    const c = o[n];
    let d, l, h = -1, m = 0;
    for (; m < c.length && (a.lastIndex = m, l = a.exec(c), l !== null); ) m = a.lastIndex, a === R ? l[1] === "!--" ? a = de : l[1] !== void 0 ? a = he : l[2] !== void 0 ? (ke.test(l[2]) && (s = RegExp("</" + l[2], "g")), a = k) : l[3] !== void 0 && (a = k) : a === k ? l[0] === ">" ? (a = s ?? R, h = -1) : l[1] === void 0 ? h = -2 : (h = a.lastIndex - l[2].length, d = l[1], a = l[3] === void 0 ? k : l[3] === '"' ? me : pe) : a === me || a === pe ? a = k : a === de || a === he ? a = R : (a = k, s = void 0);
    const g = a === k && o[n + 1].startsWith("/>") ? " " : "";
    r += a === R ? c + ze : h >= 0 ? (i.push(d), c.slice(0, h) + _e + c.slice(h) + _ + g) : c + _ + (h === -2 ? n : g);
  }
  return [Pe(o, r + (o[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), i];
};
class j {
  constructor({ strings: e, _$litType$: t }, i) {
    ...
    this.parts = [];
    let r = 0, a = 0;
    const n = e.length - 1, c = this.parts, [d, l] = Ue(e, t);
    if (this.el = j.createElement(d, i), P.currentNode = this.el.content, t === 2 || t === 3) {
      const h = this.el.content.firstChild;
      h.replaceWith(...h.childNodes);
    }
    for (; (s = P.nextNode()) !== null && c.length < n; ) {
      if (s.nodeType === 1) {
        if (s.hasAttributes()) for (const h of s.getAttributeNames()) if (h.endsWith(_e)) {
          const m = l[a++], g = s.getAttribute(h).split(_), b = /([.?@])?(.*)/.exec(m);
          c.push({ type: 1, index: r, name: b[2], strings: g, ctor: b[1] === "." ? Ve : b[1] === "?" ? Qe : b[1] === "@" ? Ge : B }), s.removeAttribute(h);
        } else h.startsWith(_) && (c.push({ type: 6, index: r }), s.removeAttribute(h));
        if (ke.test(s.tagName)) {
          const h = s.textContent.split(_), m = h.length - 1;
          if (m > 0) {
            s.textContent = Q ? Q.emptyScript : "";
            for (let g = 0; g < m; g++) s.append(h[g], z()), P.nextNode(), c.push({ type: 2, index: ++r });
            s.append(h[m], z());
          }
        }
      } else if (s.nodeType === 8) if (s.data === $e) c.push({ type: 2, index: r });
      else {
        let h = -1;
        for (; (h = s.data.indexOf(_, h + 1)) !== -1; ) c.push({ type: 7, index: r }), h += _.length - 1;
      }
      r++;
    }
  }
...
class Oe {
  ...
  u(e) {
    ...
    for (; c !== void 0; ) {
      if (a === c.index) {
        let d;
        c.type === 2 ? d = new U(r, r.nextSibling, this, e) : c.type === 1 ? d = new c.ctor(r, c.name, c.strings, this, e) : c.type === 6 && (d = new Be(r, this, e)), this._$AV.push(d), c = i[++n];
      }
...
class U {
  ...
  $(e) {
    var r;
    const { values: t, _$litType$: i } = e, s = typeof i == "number" ? this._$AC(e) : (i.el === void 0 && (i.el = j.createElement(Pe(i.h, i.h[0]), this.options)), i);
    if (((r = this._$AH) == null ? void 0 : r._$AD) === s) this._$AH.p(t);
    else {
      const a = new Oe(s, this), n = a.u(this.options);
  ...
  k(e) {
    ...
    const t = this._$AH;
    let i, s = 0;
    for (const r of e) s === t.length ? t.push(i = new U(this.O(z()), this.O(z()), this, this.options)) : i = t[s], i._$AI(r), s++;
...
class B {
  ...
  _$AI(e, t = this, i, s) {
    ...
    if (r === void 0) e = T(this, e, t, 0), a = !L(e) || e !== this._$AH && e !== I, a && (this._$AH = e);
      ...
      const n = e;
      let c, d;
      for (e = r[0], c = 0; c < r.length - 1; c++) d = T(this, n[i + c], t, c), d === I && (d = this._$AH[c]), a || (a = !L(d) || d !== this._$AH[c]), d === p ? e = p : e !== p && (e += (d ?? "") + r[c + 1]), this._$AH[c] = d;
    }
    a && !s && this.j(e);
  }
  j(e) {
...
const He = (o, e, t) => {
  ...
  if (s === void 0) {
    ...
    i._$litPart$ = s = new U(e.insertBefore(z(), r), r, void 0, t ?? {});
  }
  return s._$AI(o), s;
};
/**
...
const se = class se extends q {
  ...
  get activePlayer() {
    ...
    if (e)
      return e;
    const t = (r = this.hass) == null ? void 0 : r.states[this.selectedEntityId], i = t ? this.normalizedRoomName(String(t.attributes.friendly_name ?? t.entity_id)) : "";
    return (i ? this.allPlayers.find((a) => this.normalizedRoomName(String(a.attributes.friendly_name ?? a.entity_id)) === i) : void 0) ?? this.currentlyPlayingPlayer ?? this.allPlayers[0];
  }
  get activeEntityId() {
    var e;
  ...
  get playbackPlayer() {
    const e = this.activePlayer, i = [this.matchingMusicAssistantPlayer(e), e].filter((s, r, a) => !!s && a.findIndex((n) => (n == null ? void 0 : n.entity_id) === (s == null ? void 0 : s.entity_id)) === r);
    return i.find((s) => s.state === "playing") ?? i.find((s) => !!(s.attributes.media_title || s.attributes.entity_picture || s.attributes.entity_picture_local || s.attributes.media_image_url));
  }
  ...
  cacheItems(e, t, i, s) {
    for (e.delete(t), e.set(t, { expiresAt: Date.now() + s, items: i }); e.size > Ye; ) {
  ...
  rememberPlaybackState() {
    const e = this.playbackPlayer ?? this.activePlayer, t = String((e == null ? void 0 : e.attributes.media_title) ?? ""), i = String(
  ...
  matchingMusicAssistantPlayer(e) {
    ...
    return this.mediaPlayers.find((n) => !y(n) && r.includes(n.entity_id) && (f(n) || i(n))) ?? this.mediaPlayers.find((n) => !y(n) && (f(n) || i(n)) && this.normalizedRoomName(String(n.attributes.friendly_name ?? n.entity_id)) === a);
  }
  resolveGroupPlayers(e, t) {
    const i = [e, ...t], s = i.some((l) => O(l)), r = i.some((l) => !O(l));
    if (s && r)
      return {
        anchor: e,
        members: [],
    ...
    const a = i.some((l) => f(l)), n = i.some((l) => !f(l));
    if (!a || !n)
  ...
  groupSelected() {
    ...
    const s = i.members.map((l) => l.entity_id).filter((l, h, m) => l !== i.anchor.entity_id && m.indexOf(l) === h);
    if (s.length === 0) {
  ...
  continueInSelectedRoom() {
    ...
    const t = e[0], i = t.entity_id, s = this.playbackPlayer, r = ((c = this.matchingMusicAssistantPlayer(s)) == null ? void 0 : c.entity_id) ?? this.playbackEntityId, a = ((d = this.matchingMusicAssistantPlayer(t)) == null ? void 0 : d.entity_id) ?? (t == null ? void 0 : t.entity_id);
    if (!a || !r)
      return;
    const n = () => {
      this.selectedEntityId = i, this.pendingGroupIds = [], this.queueItems = [], this.queueError = "", this.lastInitialQueueEntityId = "", this.writeStorage(M, i), this.refreshQueueAfterPlayback();
    };
    this.groupPending = !0, this.service("music_assistant", "transfer_queue", {
      ...
      const l = s, h = String((l == null ? void 0 : l.attributes.media_content_id) ?? ""), m = String((l == null ? void 0 : l.attributes.media_content_type) ?? "music");
      if (!h) {
  ...
  async browseMediaTracks(e, t) {
    ...
    return this.cacheItems(this.browseCache, s, n, We), n;
  }
  ...
  extractBrowseTracks(e, t) {
    var c;
    const i = [], s = t.name ?? "", r = this.itemArtist(t), a = t.image || t.thumb || ((c = t.album) == null ? void 0 : c.image) || "", n = (d, l = 0) => {
      ...
      l > 0 && !!g && !!b && (m === "track" || String(h.media_class ?? "").toLowerCase().includes("track") || h.can_play && !h.can_expand && m !== "album") && i.push({
        name: b,
        uri: g,
        media_type: "track",
        type: "track",
  ...
  playSearchResult(e, t) {
    ...
    if (!i)
      return;
    const s = t ?? this.config.enqueue_mode ?? v.enqueue_mode, r = (s === "next" || s === "add") && !this.isPlaying ? "play" : s, a = this.matchingMusicAssistantPlayer(this.activePlayer), n = (a == null ? void 0 : a.entity_id) ?? "", c = this.activeEntityId;
    if (!a || !n) {
    ...
    h && !String(i).includes("://") && (d === "track" || d === "album") && (l.artist = h), m && !String(i).includes("://") && d === "track" && (l.album = m), this.service("music_assistant", "play_media", l, {
      entity_id: n
    }).catch(async (g) => {
      if (r === "next") {
        try {
    ...
    return u`
      <div class="queue-current">
        <div class="queue-current-art" style=${s ? `background-image: url("${s}")` : ""}>
          ${s ? p : u`<ha-icon .icon=${"mdi:music-note"}></ha-icon>`}
        </div>
  ...
  renderResultSection(e, t, i = "play", s = !0, r = "search") {
    if (t.length === 0)
      return p;
    const a = s ? t.slice(0, x(this.config.search_limit, v.search_limit)) : t;
    return u`
  ...
  renderSpeakers() {
    return u`
      ...
      const t = y(e), i = Math.round(x(e.attributes.volume_level, 0) * 100), s = this.volumeOverrides.get(e.entity_id) ?? i;
      return u`
  ...
  renderResultItem(e, t = "play", i = "search") {
    var d, l, h;
    const s = e.artist || ((d = e.artists) == null ? void 0 : d.map((m) => m.name).filter(Boolean).join(", ")) || ((l = e.album) == null ? void 0 : l.name) || e.media_type || e.type || "", r = e.image || e.thumb || ((h = e.album) == null ? void 0 : h.image) || "", a = this.isFavorite(e), n = () => this.playSearchResult(e, "play");
    return u`
  ...
  renderQueueItem(e, t = 0, i = !1) {
    var n, c, d;
    const s = e.artist || ((n = e.artists) == null ? void 0 : n.map((l) => l.name).filter(Boolean).join(", ")) || ((c = e.album) == null ? void 0 : c.name) || e.media_type || e.type || "", r = e.image || e.thumb || ((d = e.album) == null ? void 0 : d.image) || "", a = e.name ?? e.uri ?? "Untitled";
    return u`
      <button
  ...
  render() {
    ...
    if (!this.config)
      return u``;
    const e = this.playbackPlayer, t = this.activePlayer, i = this.activeMemory, s = y(t), r = this.artworkUrl ? `url("${this.artworkUrl}")` : "none", a = (e == null ? void 0 : e.attributes.media_title) || (i == null ? void 0 : i.title) || "No music selected", n = (e == null ? void 0 : e.attributes.media_artist) || (e == null ? void 0 : e.attributes.media_album_name) || (e == null ? void 0 : e.attributes.source) || (i == null ? void 0 : i.artist) || "Ready";
    return u`
      <ha-card>
        <div
