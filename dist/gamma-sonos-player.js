 ...
 */
const G = globalThis, te = G.ShadowRoot && (G.ShadyCSS === void 0 || G.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, se = Symbol(), oe = /* @__PURE__ */ new WeakMap();
let _e = class {
  constructor(e, t, s) {
...
const Me = (o) => new _e(typeof o == "string" ? o : o + "", void 0, se), $e = (o, ...e) => {
...
}, ce = te ? (o) => o : (o) => o instanceof CSSStyleSheet ? ((e) => {
  let t = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: ze, defineProperty: Le, getOwnPropertyDescriptor: Ne, getOwnPropertyNames: je, getOwnPropertySymbols: Ue, getPrototypeOf: Oe } = Object, $ = globalThis, le = $.trustedTypes, Ve = le ? le.emptyScript : "", H = $.reactiveElementPolyfillSupport, L = (o, e) => o, J = { toAttribute(o, e) {
  switch (e) {
    case Boolean:
      o = o ? Ve : null;
      break;
  ...
  return t;
} }, ke = (o, e) => !ze(o, e), ue = { attribute: !0, type: String, converter: J, reflect: !1, useDefault: !1, hasChanged: ke };
...
let q = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(L("properties"))) {
      const t = this.properties, s = [...je(t), ...Ue(t)];
  ...
  requestUpdate(e, t, s, i = !1, r) {
    ...
    if (e !== void 0) {
      ...
      if (i === !1 && (r = this[e]), s ?? (s = n.getPropertyOptions(e)), !((s.hasChanged ?? ke)(r, t) || s.useDefault && s.reflect && r === ((a = this._$Ej) == null ? void 0 : a.get(e)) && !this.hasAttribute(n._$Eu(e, s)))) return;
      this.C(e, t, s);
    }
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const N = globalThis, de = (o) => o, Q = N.trustedTypes, he = Q ? Q.createPolicy("lit-html", { createHTML: (o) => o }) : void 0, Pe = "$lit$", _ = `lit$${Math.random().toFixed(9).slice(2)}$`, Ae = "?" + _, Be = `<${Ae}>`, E = document, U = () => E.createComment(""), O = (o) => o === null || typeof o != "object" && typeof o != "function", ie = Array.isArray, Ge = (o) => ie(o) || typeof (o == null ? void 0 : o[Symbol.iterator]) == "function", D = `[ 	
\f\r]`, C = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, pe = /-->/g, me = />/g, P = RegExp(`>|${D}(?:([^\\s"'>=/]+)(${D}*=${D}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ge = /'/g, be = /"/g, Se = /^(?:script|style|textarea|title)$/i, Qe = (o) => (e, ...t) => ({ _$litType$: o, strings: e, values: t }), l = Qe(1), R = Symbol.for("lit-noChange"), h = Symbol.for("lit-nothing"), ye = /* @__PURE__ */ new WeakMap(), A = E.createTreeWalker(E, 129);
function Ee(o, e) {
...
const Fe = (o, e) => {
  ...
  for (let n = 0; n < t; n++) {
    const c = o[n];
    let d, p, u = -1, m = 0;
    for (; m < c.length && (a.lastIndex = m, p = a.exec(c), p !== null); ) m = a.lastIndex, a === C ? p[1] === "!--" ? a = pe : p[1] !== void 0 ? a = me : p[2] !== void 0 ? (Se.test(p[2]) && (i = RegExp("</" + p[2], "g")), a = P) : p[3] !== void 0 && (a = P) : a === P ? p[0] === ">" ? (a = i ?? C, u = -1) : p[1] === void 0 ? u = -2 : (u = a.lastIndex - p[2].length, d = p[1], a = p[3] === void 0 ? P : p[3] === '"' ? be : ge) : a === be || a === ge ? a = P : a === pe || a === me ? a = C : (a = P, i = void 0);
    const g = a === P && o[n + 1].startsWith("/>") ? " " : "";
    r += a === C ? c + Be : u >= 0 ? (s.push(d), c.slice(0, u) + Pe + c.slice(u) + _ + g) : c + _ + (u === -2 ? n : g);
  }
...
class V {
  constructor({ strings: e, _$litType$: t }, s) {
    ...
    this.parts = [];
    let r = 0, a = 0;
    const n = e.length - 1, c = this.parts, [d, p] = Fe(e, t);
    if (this.el = V.createElement(d, s), A.currentNode = this.el.content, t === 2 || t === 3) {
    ...
    for (; (i = A.nextNode()) !== null && c.length < n; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const u of i.getAttributeNames()) if (u.endsWith(Pe)) {
          ...
          c.push({ type: 1, index: r, name: f[2], strings: g, ctor: f[1] === "." ? De : f[1] === "?" ? Ke : f[1] === "@" ? We : F }), i.removeAttribute(u);
      ...
      } else if (i.nodeType === 8) if (i.data === Ae) c.push({ type: 2, index: r });
      else {
        let u = -1;
...
function M(o, e, t = o, s) {
  var a, n;
  if (e === R) return e;
  let i = s !== void 0 ? (a = t._$Co) == null ? void 0 : a[s] : t._$Cl;
  const r = O(e) ? void 0 : e._$litDirective$;
  return (i == null ? void 0 : i.constructor) !== r && ((n = i == null ? void 0 : i._$AO) == null || n.call(i, !1), r === void 0 ? i = void 0 : (i = new r(o), i._$AT(o, t, s)), s !== void 0 ? (t._$Co ?? (t._$Co = []))[s] = i : t._$Cl = i), i !== void 0 && (e = M(o, i._$AS(o, e.values), i, s)), e;
}
class He {
  constructor(e, t) {
  ...
  u(e) {
    ...
    for (; c !== void 0; ) {
      if (a === c.index) {
        let d;
        c.type === 2 ? d = new B(r, r.nextSibling, this, e) : c.type === 1 ? d = new c.ctor(r, c.name, c.strings, this, e) : c.type === 6 && (d = new Ye(r, this, e)), this._$AV.push(d), c = s[++n];
      }
...
class B {
  ...
  _$AI(e, t = this) {
    e = M(this, e, t), O(e) ? e === h || e == null || e === "" ? (this._$AH !== h && this._$AR(), this._$AH = h) : e !== this._$AH && e !== R && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Ge(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  $(e) {
    var r;
    const { values: t, _$litType$: s } = e, i = typeof s == "number" ? this._$AC(e) : (s.el === void 0 && (s.el = V.createElement(Ee(s.h, s.h[0]), this.options)), s);
    if (((r = this._$AH) == null ? void 0 : r._$AD) === i) this._$AH.p(t);
    else {
      const a = new He(i, this), n = a.u(this.options);
  ...
  k(e) {
    ...
    const t = this._$AH;
    let s, i = 0;
    for (const r of e) i === t.length ? t.push(s = new B(this.O(U()), this.O(U()), this, this.options)) : s = t[i], s._$AI(r), i++;
...
class F {
  ...
  _$AI(e, t = this, s, i) {
    ...
    let a = !1;
    if (r === void 0) e = M(this, e, t, 0), a = !O(e) || e !== this._$AH && e !== R, a && (this._$AH = e);
    else {
      const n = e;
      let c, d;
      for (e = r[0], c = 0; c < r.length - 1; c++) d = M(this, n[s + c], t, c), d === R && (d = this._$AH[c]), a || (a = !O(d) || d !== this._$AH[c]), d === h ? e = h : e !== h && (e += (d ?? "") + r[c + 1]), this._$AH[c] = d;
    }
    a && !i && this.j(e);
  }
  j(e) {
...
const Je = (o, e, t) => {
  ...
  if (i === void 0) {
    ...
    s._$litPart$ = i = new B(e.insertBefore(U(), r), r, void 0, t ?? {});
  }
  return i._$AI(o), i;
};
/**
...
var we;
I._$litElement$ = !0, I.finalized = !0, (we = S.litElementHydrateSupport) == null || we.call(S, { LitElement: I });
...
const v = {
  ...
  background: "#101722",
  accent_color: "#39d98a"
}, Ze = 524288, z = "gamma-sonos-player:last-player", fe = "gamma-sonos-player:playback-memory", ve = "gamma-sonos-player:favorites", Xe = 1e4, Y = 12e3, et = 2 * 6e4, tt = 5 * 6e4, st = 30, it = 15e3, Te = "rest_command.party_screen_start", qe = "rest_command.party_screen_stop", Ie = "https://music.anieflix.com/#/party", Z = "Lanai AppleTV";
function x(o, e) {
...
function rt(o) {
  return !!(x(o == null ? void 0 : o.attributes.supported_features, 0) & Ze) || Array.isArray(o == null ? void 0 : o.attributes.group_members);
}
function y(o) {
...
const re = class re extends I {
  ...
  cacheItems(e, t, s, i) {
    for (e.delete(t), e.set(t, { expiresAt: Date.now() + i, items: s }); e.size > st; ) {
  ...
  readFavoriteItems() {
    try {
      const e = JSON.parse(this.readStorage(ve) || "[]");
  ...
  writeFavoriteItems(e) {
    this.writeStorage(ve, JSON.stringify(e.slice(0, 60)));
  }
  favoriteKey(e) {
  ...
  nativeSonosMatch(e) {
    ...
    return this.mediaPlayers.find((s) => xe(s) && this.normalizedRoomName(String(s.attributes.friendly_name ?? s.entity_id)) === t);
  }
  ...
  get groupablePlayers() {
    ...
    return t ? this.allPlayers.filter((i) => {
      if (b(i) || !this.isSonosBackedPlayer(i))
        return !1;
      const r = this.matchingMusicAssistantPlayer(i), a = rt(i) || y(i) || !!r, n = (r == null ? void 0 : r.entity_id) ?? i.entity_id;
  ...
  resolveGroupPlayers(e, t) {
    ...
    if (c.length !== t.length) {
      const d = t.filter((p) => !this.matchingMusicAssistantPlayer(p)).map((p) => p.attributes.friendly_name ?? w(p.entity_id.split(".")[1]));
      return {
        anchor: n,
        members: [],
  ...
  groupSelected() {
    ...
    if (this.groupPending || !t || this.pendingGroupIds.length === 0)
      return;
    const s = this.pendingGroupIds.filter((u) => u !== t).map((u) => {
      var m;
    ...
    const a = this.selectedEntityId, n = [...this.selectedGroupIds], c = [...this.pendingGroupIds], d = t, p = s.map((u) => u.entity_id);
  ...
  continueInSelectedRoom() {
    ...
    const t = e.entity_id, s = this.playbackPlayer, i = ((c = this.matchingMusicAssistantPlayer(s)) == null ? void 0 : c.entity_id) ?? this.playbackEntityId, r = ((d = this.matchingMusicAssistantPlayer(e)) == null ? void 0 : d.entity_id) ?? (e == null ? void 0 : e.entity_id);
    if (!r || !i)
      return;
    const a = () => {
  ...
  async fetchMusicAssistantSearch(e) {
    ...
    return this.cacheItems(this.searchCache, t, r, et), r;
  }
  ...
  async browseMediaTracks(e, t) {
    ...
    return this.cacheItems(this.browseCache, i, n, tt), n;
  }
  ...
  extractBrowseTracks(e, t) {
    var c;
    const s = [], i = t.name ?? "", r = this.itemArtist(t), a = t.image || t.thumb || ((c = t.album) == null ? void 0 : c.image) || "", n = (d, p = 0) => {
  ...
  playSearchResult(e, t) {
    ...
    p ? this.startPlaybackFeedback(e, d) : (this.clearPlaybackFeedback(), this.playbackStatus = `Adding ${e.name ?? "item"} to the queue…`);
    ...
    g && !String(s).includes("://") && (u === "track" || u === "album") && (m.artist = g), f && !String(s).includes("://") && u === "track" && (m.album = f), (async () => {
      ...
      try {
        ...
        if (r === "next")
          ...
          this.playbackError = `Could not play this item on ${a.attributes.friendly_name ?? n}: ${this.errorMessage(ne, "Music Assistant playback failed.")}`;
      } finally {
  ...
  renderPlayerPicker(e) {
    ...
    if (!t)
      return l``;
    const s = this.playerQuickStatus(t);
    return l`
      <label class="player-select">
        ...
        <span class="player-select-copy">
          ...
          <span class="player-select-status">${s} · Choose speaker</span>
        </span>
        ...
        >
          ${e.map((i) => l`
            <option value=${i.entity_id}>
              ${this.playerPickerLabel(i, e)} — ${this.playerQuickStatus(i)}
            </option>
          `)}
        </select>
      </label>
    ...
    return l`
      <section class="mini-player">
        <div class="mini-art" aria-label="Artwork">
          ${i ? l`<img src=${i} alt="" loading="eager" decoding="async" />` : l`<ha-icon .icon=${"mdi:music-note"}></ha-icon>`}
        </div>
        <div class="mini-meta">
  ...
  renderGrouping() {
    ...
    const i = e.some((c) => c.entity_id === s) || !!this.matchingMusicAssistantPlayer(t), r = this.pendingGroupIds.filter((c) => {
      ...
      return c !== s && e.some((u) => u.entity_id === (d == null ? void 0 : d.entity_id));
  ...
  renderUpNextPreview() {
    ...
    return l`
      ...
      this.activeTab = "queue", this.refreshQueue();
        ...
        ${this.queueLoading && e.length === 0 ? l`<div class="hint">Loading what’s next…</div>` : h}
        ${e.length > 0 ? l`
  ...
  runPartyAction(e) {
    if (!this.partyPending) {
      ...
      try {
        const t = e === "start" ? this.config.party_start_service : this.config.party_stop_service, s = e === "start" ? Te : qe, [i, r] = this.configuredService(t, s);
        this.service(i, r).then(() => {
          this.partyStatus = e === "start" ? `Party screen sent to ${this.config.party_screen_name || Z}.` : "Party screen stopped.";
        }).catch((a) => {
  ...
  renderParty() {
    const e = this.config.party_screen_name || Z;
    return l`
      <section class="party">
  ...
  renderResultItem(e, t = "play", s = "search") {
    var d, p, u;
    const i = e.artist || ((d = e.artists) == null ? void 0 : d.map((m) => m.name).filter(Boolean).join(", ")) || ((p = e.album) == null ? void 0 : p.name) || e.media_type || e.type || "", r = e.image || e.thumb || ((u = e.album) == null ? void 0 : u.image) || "", a = this.isFavorite(e), n = () => this.playSearchResult(e, "play");
    return l`
      ...
      m.stopPropagation(), this.toggleFavorite(e);
          ...
          ${t === "artist" || t === "album" || t === "playlist" ? h : l`
                <button
                  class="now"
                  ?disabled=${this.playbackPending}
                  @click=${(m) => {
  ...
  renderQueueItem(e, t = 0, s = !1) {
    var n, c, d;
    const i = e.artist || ((n = e.artists) == null ? void 0 : n.map((p) => p.name).filter(Boolean).join(", ")) || ((c = e.album) == null ? void 0 : c.name) || e.media_type || e.type || "", r = e.image || e.thumb || ((d = e.album) == null ? void 0 : d.image) || "", a = e.name ?? e.uri ?? "Untitled";
    return l`
      <button
...
const ae = class ae extends I {
  ...
  autoConfigureMusicAssistantPlayers() {
    ...
    const t = Object.values(((a = this.hass) == null ? void 0 : a.states) ?? {}).filter((n) => !!n).filter((n) => y(n) && !b(n)), s = this.config.entities ?? [], r = (s.length > 0 ? s.map((n) => {
      ...
      return ((u = t.find((m) => j(String(m.attributes.friendly_name ?? m.entity_id)) === d)) == null ? void 0 : u.entity_id) ?? n;
